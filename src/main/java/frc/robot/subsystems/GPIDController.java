...
public class GPIDController implements Sendable, AutoCloseable {
   ...
   */
  public GPIDController(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
  ...
  public GPIDController(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
   ...
   */
  public double getIntegralDeadband() {
    return m_integralDeadband;
  }
...
/**
  ...
  public void setIntegralDeadband(double integralDeadband) {
    m_integralDeadband = integralDeadband;
  }
