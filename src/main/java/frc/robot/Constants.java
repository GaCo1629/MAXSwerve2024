...
public final class Constants {
  public static final class DriveConstants {
    public static final double kAtleeSpeedFactor     = 1; // Revised down due to new Joystick math // was 0.8
    public static final double kAtleeTurnFactor      = 0.70; // Revised down due to new Joystick math // was 0.6
    public static final double kAlexSpeedFactor      = 1.2; // Revised down due to new Joystick math // was 0.8
  ...
  public static final class TiltConstants { 
    // Calculations required for driving motor conversion factors and feed forward
    public static final double kP = 0.022;    // was 0.020
    public static final double kI = 0.04;    // was 0.015
    ...
    public static final double ampLowAngle = 61;
    public static final double ampHighAngle = 80;
